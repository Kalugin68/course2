...
class MainWindow:
    def __init__(self, master):
        ...
        self.system_label = ctk.CTkLabel(self.frame_calculate,
        ...
        # Кнопка "Вычислить"
        self.calculate_button = ctk.CTkButton(self.frame_buttons,
                                              text="Вычислить",
        ...
        # Кнопка "Копировать"
        self.copy_button = ctk.CTkButton(self.frame_buttons,
                                         text="Копировать",
        ...
        # Кнопка "Очистить"
        self.clear_button = ctk.CTkButton(self.frame_buttons,
                                          text="Очистить",
        ...
        # Кнопка перестановки
        self.swap_button = ctk.CTkButton(self.frame_buttons,
                                         text="Переставить",
        ...
        self.label_image_info = ctk.CTkLabel(self.frame_calculate,
                                             text="",
