...
class TheoryWindow:
    def __init__(self, master, main_window):
        ...
        self.main_frame = Frame(self.theory_window, padx=10, pady=10, borderwidth=1, relief="sunken", bg="#DCDCDC")
        ...
        # Заголовок
        Label(self.main_frame, text="Виды систем счисления:",
              font=("Arial", 18, "bold"), bg="#DCDCDC").pack(anchor="w", padx=30, pady=10)

        # Десятичная система
        Label(self.main_frame, text="1. Десятичная система (основание 10)",
              font=header_font, bg="#DCDCDC").pack(anchor="w", padx=10, pady=5)
        ...
        ), font=body_font, bg="#DCDCDC", wraplength=750).pack(anchor="w", padx=20, pady=5)

        # Двоичная система
        Label(self.main_frame, text="2. Двоичная система (основание 2)",
              font=header_font, bg="#DCDCDC").pack(anchor="w", padx=10, pady=5)
        Label(self.main_frame, text=(
        ...
        ), font=body_font, wraplength=750, bg="#DCDCDC").pack(anchor="w", padx=20, pady=5)

        # Шестнадцатеричная система
        Label(self.main_frame, text="3. Шестнадцатеричная система (основание 16)",
              font=header_font, bg="#DCDCDC").pack(anchor="w", padx=10, pady=5)
        Label(self.main_frame, text=(
        ...
        Label(self.main_frame, text="4. Восьмеричная система (основание 8)",
              font=header_font, bg="#DCDCDC").pack(anchor="w", padx=10, pady=5)
        Label(self.main_frame, text=(
        ...
        self.style.configure("back.TButton", font=("Calibri", 10), padding=(15, 3))
        # Кнопка закрытия окна
        close_button = ttk.Button(self.theory_window, text="Назад", style="back.TButton",
